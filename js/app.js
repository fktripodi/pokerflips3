document.addEventListener('DOMContentLoaded', () => {
    ...
    function showPage(pageNumber) {
        content.innerHTML = `<h1>PAGE ${pageNumber}</h1><button id="return-main">Return to Main Screen</button>`;
        document.getElementById('return-main').addEventListener('click', () => {
            location.reload(); // Reload the page to return to the main screen
        });
    }
